...
**Survivors.** Across both evaluation batches, 9 unique sequences survived the full pipeline. All 9 came from seeded mode. The lead candidate was sequence 2508_len279 from the full_nc8_lrgen_5e-5_lrcrit_5e-4 checkpoint, with a DNA-SAM binding distance of 5.425 Å. This sequence was structurally validated by an external chemistry professor who confirmed DNMT-3a-like secondary structure with preserved hydrophilic interactions for SAM-mediated methylation. The true minimum distance in the eval set, 5.272 Å, actually belongs to a different sequence -- 2405_len258 from the 10p_nc8_lrgen_5e-6_lrcrit_5e-5 checkpoint -- which has not gone through chemist structural review or MD simulation. 30 AF3 error sequences from the 120k batch remain unevaluated and are potential candidates.
